            ...
            <div class="owl-carousel owl-theme">
                @foreach ($nuevas as $nueva)
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h3>{{ Str::title($nueva->titulo)}}</h3> {{--title convierte la primera letra en mayuscula, revisar la documentacion de laravel en la seccion digging deeper-> Helpers --}}
                            <p>{{ Str::words (strip_tags($nueva->preparacion), 12)}}</p> {{-- strip_tags es para eliminar las etiquetas  , limit corta por letras mientras que words lo hace por palabras --}}
